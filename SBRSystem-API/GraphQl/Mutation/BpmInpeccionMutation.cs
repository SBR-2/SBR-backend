...
public class BpmInpeccionMutation
{
        ...
        [Service] MySBRDbContext context)
    {
        Establecimiento newEstablecimiento = new Establecimiento
        {
            ...
            InicioOperaciones = input.InicioOperaciones.ToLocalTime(),
            VencimientoSanitario = input.VencimientoSanitario.ToLocalTime(),
            Rnc = input.Rnc,
            ...
            UltimaInspeccion = input.UltimaInspeccion.ToLocalTime(),
